...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__8978){
var map__8984 = p__8978;
var map__8984__$1 = cljs.core.__destructure_map(map__8984);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8984__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (on_write.cljs$core$IFn$_invoke$arity$1 ? on_write.cljs$core$IFn$_invoke$arity$1(rendered_value) : on_write(rendered_value));
} else {
return null;
}
} else {
...
var _STAR_force_set_dom_value_STAR__orig_val__9006 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__9007 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__9007);

try{return (reagent.impl.input.input_component_set_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.input.input_component_set_value.cljs$core$IFn$_invoke$arity$1(component) : reagent.impl.input.input_component_set_value(component));
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__9006);
}}));
} else {
...
if(cljs.core.fn_QMARK_(on_write)){
(on_write.cljs$core$IFn$_invoke$arity$1 ? on_write.cljs$core$IFn$_invoke$arity$1(rendered_value) : on_write(rendered_value));
} else {
}
...
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(e) : on_change(e));
});
...
return (original_ref_fn.cljs$core$IFn$_invoke$arity$1 ? original_ref_fn.cljs$core$IFn$_invoke$arity$1(el) : original_ref_fn(el));
...
(jsprops.onChange = (function (p1__9026_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__9026_SHARP_);
}));
