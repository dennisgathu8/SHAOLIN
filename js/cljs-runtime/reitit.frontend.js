...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,(function (p1__13307_SHARP_){
return reitit.frontend.query_param(q,p1__13307_SHARP_);
})),q.getKeys()));
});
/**
...
var new_query = ((cljs.core.fn_QMARK_(new_query_or_update_fn))?(function (){var G__13309 = reitit.frontend.query_params(uri);
return (new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1 ? new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1(G__13309) : new_query_or_update_fn(G__13309));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13319),"#",reitit.impl.form_encode(fragment)].join('');
} else {
return G__13319;
}
} else {
...
(reitit.frontend.match_by_path.cljs$core$IFn$_invoke$arity$3 = (function (router,path,p__13324){
var map__13325 = p__13324;
var map__13325__$1 = cljs.core.__destructure_map(map__13325);
var on_coercion_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13325__$1,new cljs.core.Keyword(null,"on-coercion-error","on-coercion-error",-970787));
var uri = goog.Uri.parse(path);
...
var e = e13326;
(on_coercion_error.cljs$core$IFn$_invoke$arity$2 ? on_coercion_error.cljs$core$IFn$_invoke$arity$2(match,e) : on_coercion_error(match,e));
...
var parameters = (function (){var or__5002__auto__ = (coerce_BANG_.cljs$core$IFn$_invoke$arity$1 ? coerce_BANG_.cljs$core$IFn$_invoke$arity$1(match__$1) : coerce_BANG_(match__$1));
...
if(cljs.core.every_QMARK_((function (p1__13333_SHARP_){
return cljs.core.contains_QMARK_(path_params,p1__13333_SHARP_);
