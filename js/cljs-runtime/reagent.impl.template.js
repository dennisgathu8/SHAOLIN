...
var G__9058 = o;
reagent.impl.template.goog$module$goog$object.set(G__9058,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value(v)));
...
return (function() { 
var G__9253__delegate = function (args){
...
var G__9061 = o;
reagent.impl.template.goog$module$goog$object.set(G__9061,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__9262__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
var G__9065 = props;
var G__9065__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9065,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__9065);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9065__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__9068 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9068,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__9068;
}
})(),id_class);
...
var G__9069 = (cljs.core.count(argv) - first_child);
switch (G__9069) {
case (0):
...
var vec__9092 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9092,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9092,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9092,(2),null);
...
var temp__5808__auto___9287 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5808__auto___9293 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___9293 == null)){
} else {
var key_9294 = temp__5808__auto___9293;
...
var temp__5808__auto___9299 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___9299 == null)){
} else {
var key_9301 = temp__5808__auto___9299;
(jsprops.key = key_9301);
}
...
var temp__5808__auto___9318 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___9318 == null)){
} else {
var key_9319 = temp__5808__auto___9318;
(jsprops.key = key_9319);
}
...
var temp__5808__auto___9324 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___9324 == null)){
} else {
var key_9325 = temp__5808__auto___9324;
(jsprops.key = key_9325);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9161_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__9161_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__9171 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9171,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9171,(1),null);
...
break;
default:
var G__9340 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__9341 = compiler;
v = G__9340;
compiler = G__9341;
continue;
...
return (fn_to_element.cljs$core$IFn$_invoke$arity$3 ? fn_to_element.cljs$core$IFn$_invoke$arity$3(tag,v,compiler) : fn_to_element(tag,v,compiler));
...
*/
reagent.impl.template.t_reagent$impl$template9225 = (function (opts,id,fn_to_element,parse_fn,meta9226){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template9225.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_9227,meta9226__$1){
var self__ = this;
var _9227__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template9225(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta9226__$1));
}));

(reagent.impl.template.t_reagent$impl$template9225.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_9227){
var self__ = this;
var _9227__$1 = this;
return self__.meta9226;
}));

(reagent.impl.template.t_reagent$impl$template9225.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template9225.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template9225.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return (self__.parse_fn.cljs$core$IFn$_invoke$arity$3 ? self__.parse_fn.cljs$core$IFn$_invoke$arity$3(this$__$1,tag_name,tag_value) : self__.parse_fn(this$__$1,tag_name,tag_value));
}));

(reagent.impl.template.t_reagent$impl$template9225.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template9225.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template9225.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta9226","meta9226",-1763951021,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template9225.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template9225.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template9225");

(reagent.impl.template.t_reagent$impl$template9225.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template9225");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template9225.
 */
reagent.impl.template.__GT_t_reagent$impl$template9225 = (function reagent$impl$template$__GT_t_reagent$impl$template9225(opts,id,fn_to_element,parse_fn,meta9226){
return (new reagent.impl.template.t_reagent$impl$template9225(opts,id,fn_to_element,parse_fn,meta9226));
});
...
return (new reagent.impl.template.t_reagent$impl$template9225(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
