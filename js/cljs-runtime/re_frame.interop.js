...
return [(function (){var pred__9608 = cljs.core.instance_QMARK_;
var expr__9609 = reactive_val;
if(cljs.core.truth_((pred__9608.cljs$core$IFn$_invoke$arity$2 ? pred__9608.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__9609) : pred__9608(reagent.ratom.RAtom,expr__9609)))){
return "ra";
} else {
if(cljs.core.truth_((pred__9608.cljs$core$IFn$_invoke$arity$2 ? pred__9608.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__9609) : pred__9608(reagent.ratom.RCursor,expr__9609)))){
return "rc";
} else {
if(cljs.core.truth_((pred__9608.cljs$core$IFn$_invoke$arity$2 ? pred__9608.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__9609) : pred__9608(reagent.ratom.Reaction,expr__9609)))){
return "rx";
} else {
if(cljs.core.truth_((pred__9608.cljs$core$IFn$_invoke$arity$2 ? pred__9608.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__9609) : pred__9608(reagent.ratom.Track,expr__9609)))){
return "tr";
} else {
return "other";
}
